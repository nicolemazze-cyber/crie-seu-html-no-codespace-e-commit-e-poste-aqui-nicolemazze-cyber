...
Na seguencia faça um commit.. para salvar no repositorio da tafefa ...
...
Alternativa: Clique no botão "Go Live" que aparece na barra de status inferior, no canto direito.
O GitHub Codespaces exibirá uma notificação no canto inferior informando que uma porta foi aberta. 
Clique em "Open in Browser" para ver seu site ao vivo.
